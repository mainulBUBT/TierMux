import type { WebSearchEngine, WebSearchResult, SearchAttempt } from "./types";
import { buildQueryTokens, countQueryHits, cleanSearchText, cleanSearchSnippet } from "./text";
import { normalizeSearchResultUrl, normalizeDomainFilter, domainMatches, isInternalSearchEngineUrl } from "./url";
import { isUrlSafe } from "./security";
import { extractDateHint, checkDateFreshness } from "./dates";
import { TRUSTED_DOMAINS, LOW_QUALITY_DOMAINS } from "./constants";
